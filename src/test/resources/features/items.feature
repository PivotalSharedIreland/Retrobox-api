Feature: Retro Box API manage boar items
  ...
  Scenario: Find board items
    ...
    And items are
      ...
      | items[0].type               | HAPPY                   |
      | items[0].creation_date      | 2016-01-01T20:30:00Z    |
      | items[0].last_modified_date | 2016-01-01T20:30:00Z    |
      | items[0].likes              | 0                       |
      | items[0].board_id           | 1                       |
      | items[2].message            | I'm a different message |
      | items[2].status             | ACTIVE                  |
      | items[2].type               | SAD                     |
      | items[2].creation_date      | 2016-01-01T21:32:00Z    |
      | items[2].last_modified_date | 2016-01-01T21:32:00Z    |
      | items[2].likes              | 1                       |
      | items[2].board_id           | 1                       |
      | items[3].message            | I'm a different message |
      | items[3].status             | ARCHIVED                |
      | items[3].type               | MEDIOCRE                |
      | items[3].creation_date      | 2016-01-01T21:32:00Z    |
      | items[3].last_modified_date | 2016-01-01T21:32:00Z    |
      | items[3].likes              | 1                       |
      | items[3].board_id           | 1                       |
